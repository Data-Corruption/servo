// Package release resolves the latest published version from a release URL.
//
// --- UPDATE CHECK --- this whole package belongs to the "UPDATE CHECK" block;
// delete the package (and internal/app/update_test.go) when removing update
// checking. See internal/app/update_check.go for the full recipe.
package release
