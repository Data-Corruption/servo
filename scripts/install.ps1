...
#
# NOTE: this script pipes the Linux installer (curl | sh) inside WSL without
# cosign-verifying install.sh itself first, so it is lower-assurance than the
# documented Linux install path. The installer still cosign-verifies the
# artifacts it downloads. See docs/INSTALLATION.md.
#
# This script will:
